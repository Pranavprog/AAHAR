...
export default function HomePage() {
  return (
    <div className="space-y-12">
      <section className="text-center py-12 md:py-20 bg-gradient-to-br from-primary/20 via-background to-background rounded-lg shadow-md overflow-hidden">
        <div className="container mx-auto px-4">
          <Leaf className="mx-auto text-primary h-16 w-16 mb-6 hover:scale-110 hover:rotate-[-10deg] transition-all duration-300 ease-in-out cursor-pointer" />
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="shadow-lg group hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 ease-in-out">
            <CardHeader>
