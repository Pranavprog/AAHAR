...
const TargetCursor: React.FC<TargetCursorProps> = ({ targetSelector = '.cursor-target', spinDuration = 2, hideDefaultCursor = true }) => {
  ...
  useEffect(() => {
    ...
    let currentTargetMove: ((this: HTMLElement, ev: MouseEvent) => any) | null = null;
